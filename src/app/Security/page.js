                ...
                <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                  <div className="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                    ...
                    <p className="mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none">
                      At Machador, we redefine team onboarding with an
                      unwavering commitment to security and privacy. Our
                      intelligent AI chatbot solution is built on a foundation
                      of advanced encryption and compliance standards, ensuring
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="mt-4 text-black-300">
              Dive deeper into the layers of security that protect your data
              within the Machador ecosystem. Adherence to global privacy
              regulations protects your data across borders.
            </p>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <h2 className="mt-4 text-xl font-bold text-black no-underline">
                Robust Technical Infrastructure
              </h2>

              <p className="mt-1 text-sm text-black no-underline">
                Leveraging Node.js, VectorDB, and MongoDB for fast, responsive,
                and secure data handling, underpinned by OAuth2 authentication
                and SHA-256 encryption.
              </p>
            </a>
            ...
            >
              ...
              <p className="mt-1 text-sm text-black">
                Our EU-based servers comply with GDPR mandates, featuring
                rigorous security audits and compliance checks with hosting
                services to ensure the highest standards of data protection.
              </p>
            </a>
            ...
            >
              ...
              <p className="mt-1 text-sm text-black">
                A dynamic GDPR checklist guides our operations, focusing on
                user-controlled data deletion capabilities and strict data
                processing documentation, for uncompromised privacy.
              </p>
            </a>
            ...
            >
              ...
              <p className="mt-1 text-sm text-black">
                Our APIs employ documented encryption and authentication,
                fortified by TLS protocols, to secure data exchange and maintain
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray-black">
                Our structured notification and mitigation strategy enables
                swift incident response, supported by a team of cybersecurity
                experts dedicated to maintaining operational resilience.
              </p>
            </a>
            ...
            >
              ...
              <p className="mt-1 text-sm text-black">
                Ongoing monitoring systems evaluate the effectiveness of our
                security measures, ensuring continuous improvement and
                adaptation to evolving threats and compliance standards.
              </p>
            </a>
          </div>
        ...
        <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8 ">
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16 bg-gradient-to-r from-[rgba(16,163,209,1)] to-[rgba(0,213,187,1)]">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-white">
              Ready to transform your onboarding experience? Click here to
              unleash the power of AI, streamline your process, and ensure your
              customers receive instant, 24/7 support. No coding needed. Start
