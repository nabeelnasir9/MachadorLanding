...
export const GoogleGeminiEffect = ({
  ...
  //     { top: '410px', left: '205px' },
  //     { top: '331px', left: '205px' },
  //     { top: '255px', left: '205px' },
  //     { top: '181px', left: '205px' },
  //   ],
  //   end: [
  //     { top: '480px', right: '210px' },
  //     { top: '410px', right: '210px' },
  //     { top: '331px', right: '210px' },
  //     { top: '255px', right: '210px' },
  //     { top: '181px', right: '210px' },
  //   ],
  // };
  ...
  return (
    <div className={`sticky top-80 relative ${className}`}>
      ...
      <p
        className="text-xs md:text-xl font-semibold text-center text-black mt-4 max-w-xl mx-auto"
        style={{
          background:
      ...
      {/* <motion.div className="LeftIconsOfGemini">
        <Image
          src="/ico.png"
          width={50}
          height={50}
          className="LeftGeminiIcon1"
        />
        <Image
          src="/ico1.png"
          width={50}
          height={50}
          className="LeftGeminiIcon2"
        />
        <Image
          src="/ico2.png"
          width={50}
          height={50}
          className="LeftGeminiIcon3"
        />
        <Image
          src="/ico3.png"
          width={50}
